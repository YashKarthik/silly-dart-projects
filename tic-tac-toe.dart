...
void main(){
	...
	for(int i = 0; i <= 9; i++){
		...
		String? point = stdin.readLineSync() ?? '1,1';
		List <int> points = [];
		points.addAll((point.split(',')).map((x) => int.parse(x))); // addAll elements of the integer iterable (to points) generated by mapping parse() to each elem of the string list (point)
